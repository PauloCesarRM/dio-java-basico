...
public class ProcessoSeletivo {
    public static void main(String[] args) {
        ...
        String [] candidatos = {"Paulo", "Samuel", "Márcio", "Joãozinho", "Chaves"};
    ...
    static void selecaoCandidatos(){
        String [] candidatos = {"Paulo", "Samuel", "Márcio", "Joãozinho", "Chaves", "Maria Chiquinha", "Kiko", "Nhonho", "Mangaba", "Augusto"};
